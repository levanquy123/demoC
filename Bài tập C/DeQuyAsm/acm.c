...
int main()
{
    ...
    do
    {
        ...
        printf("--Chao mung den voi V-League 2008--\n");
        printf("===================================\n");
...
void capnhatdanhsachdoibong()
{
    ...
    doibong = (struct DoiBong *)malloc(n * sizeof(struct DoiBong));
    ...
    do
    {
        ...
        printf("- Nhập mã đội: ");
        scanf("%s", doibong[n].Madoi);
        printf("- Nhập tên đội: ");
        scanf("%s", doibong[n].Tendoi);
        fflush(stdin);
        printf("- Nhập tên huấn luyện viên: ");
        scanf("%s", doibong[n].TenHlv);
        fflush(stdin);
